 ...
 * @author Adam
 */
public class DeviceRankingWorker extends AbstractDeviceRankingWorker {
     ...
     * @param deviceTable
     */
    public DeviceRankingWorker(int days, JTable deviceTable) {
        super(deviceTable);
        this.days = days;
    }
    ...
    protected List<AndroidDeviceRanking> doInBackground() throws Exception {
        ...
        return dao.getUnidentifiedDevices(days);
    }
